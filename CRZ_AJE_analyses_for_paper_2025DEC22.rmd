...
ctrl <- read_sf("/data/control_shapefile/crz_control.shp")
...
boston24 <- read_sf("/data/boston/2024_Crashes/2024_Crashes.shp") %>% clean_names() %>%
  filter(city_town == "BOSTON")
  
boston25 <- read_sf("/data/boston/2025_Crashes/2025_Crashes.shp") %>% clean_names() %>%
...
boros <- read_sf("/data/boros_without_arterials/boros_without_arterials.shp") |> clean_names()
